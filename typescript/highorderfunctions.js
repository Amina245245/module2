...
//     if(player.total_runs>20000)
//     console.log(player.name,player.total_runs);
// });
//map creates  new arrays from  existing arrays
// var newScores=
// scores.map(function(score)  //function and=> are same
// {
//     return(score*2);
// });
...
var sumScores = players.reduce(function (cumTotal, player) {
